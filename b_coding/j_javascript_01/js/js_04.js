...
// 객체 : 무엇(주어)/어떻게 , 속성명:값
// 배열 : 값의 나열
// bollean : 참true 거짓false 을 비교하여 판단
// 문자 : '', "" 묶여서 글자로 인지되는 형태
// 숫자 : 소수, 음수, 양수, 정수 관계없이 숫자 형태
// null : 이미사용한 변수/배열/객체의 내용을 비우는것
// undefined : 사용하기전 선언은 되어있으나 값이 비어있는것
